...
You can then view the [[https://github.com/kyrarivest/ACRES_REU_Project_2021/blob/main/examples/results.txt][*results.txt*]] file to see a list of the results for multiple PCA training/testing model examples if you run many.
